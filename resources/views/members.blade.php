            ...
            <div>
                ...
                <div class="bg-white p-4 rounded-2xl border border-gray-100 shadow-sm space-y-3">
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500 font-medium"><i class="fa-solid fa-star text-yellow-400 w-4 text-center mr-1.5"></i> Plan</span>
                        <span id="view-card-plan" class="font-bold text-gray-900">N/A</span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500 font-medium"><i class="fa-solid fa-calendar-check text-blue-400 w-4 text-center mr-1.5"></i> Joined</span>
                        <span id="view-card-joined" class="font-bold text-gray-900">N/A</span>
                    </div>
                    <div class="flex justify-between items-center text-sm">
                        <span class="text-gray-500 font-medium"><i class="fa-solid fa-coins text-emerald-400 w-4 text-center mr-1.5"></i> Total Paid</span>
...
<script>
    ...
    function calculateTotal() {
        ...
        if (!isEditing) {
            document.getElementById('amount_received').value = total; // Auto-fill only for new
        }
        calculatePending();
    }
