...
<script>
    ...
    if (user) {
        ...
        // Show gym logo only if it's set, otherwise keep dumbbell icon
        ...
        if (user.gym && user.gym.logo && sbLogoImg && sbLogoIcon) {
        ...
        // If no logo: dumbbell icon stays visible (default state)
